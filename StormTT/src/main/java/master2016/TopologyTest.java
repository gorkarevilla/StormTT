...
public class TopologyTest {
	...
	private static String[] hashtagsES = { "hola", "que", "si", "adios", "casa", "piso", "coche", "dormir", "bien",
			"mal" };
	private static String[] hashtagsEN = { "hello", "bye", "yes", "no", "home", "sleep", "try", "best", "good", "bad" };
	private static String[] hashtagsAR = { "carro", "hogar", "pive", "chao", "chevere", "boludo", "mate", "coger",
			"che", "linda" };
	...
	public static void main(String[] args) {
		...
		topology = new Topology("StormTopology","localhost:9092", langList, "output/","16");
